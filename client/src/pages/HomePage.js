// C:\Users\Admin\RAUL\client\src\pages\HomePage.js
...
function HomePage() {
  ...
  useEffect(() => {
    const fetchRestaurant = async () => {
      try {
        // Fetch all restaurants and take the first one (KCA Streetfood)
      ...
      <div className="p-4">
        <div className="bg-white rounded-lg overflow-hidden shadow-md">
          ...
          <div className="p-4">
            ...
            <div className="flex flex-wrap mb-3">
              {restaurant.features && restaurant.features.map((feature, index) => (
        ...
        <div className="mt-6 bg-white rounded-lg shadow-md p-4">
          ...
          <div className="flex justify-between py-2">
            ...
            <span>08:00 - {restaurant.closing_time}</span>
          </div>
          <div className="flex justify-between py-2">
